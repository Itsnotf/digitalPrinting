                                ...
                                <form action="{{ route('cekout') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-control mb-2 @error('id_pembayaran') is-invalid @enderror"
                                                ...
                                                <input  type="number" class="form-control @error('bukti') is-invalid @enderror" id="bukti" disabled >
                                                @error('id_pembayaran')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
